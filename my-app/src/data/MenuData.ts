const MenuData = [
  {
    ...
    icon:
      `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           ...
           strokeLinecap="round" strokeLinejoin="round" className="homepage-svg">
  ...
  },
  {
    ...
    `  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           ...
           strokeLinecap="round" strokeLinejoin="round" className="trending-svg">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  },
  {
    ...
    icon: 
      `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
           strokeLinecap="round" strokeLinejoin="round" className="coding-svg">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  },
  {
    ...
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
           strokeLinecap="round" strokeLinejoin="round" className="javascript-svg">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  },
  {
    ...
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
           strokeLinecap="round" strokeLinejoin="round" className="react-js-svg">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  },
  {
    ...
    icon: 
      `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
           strokeLinecap="round" strokeLinejoin="round" className="music-svg">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  },
  {
    ...
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
           strokeLinecap="round" strokeLinejoin="round" className="education-svg">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  },
  {
    ...
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           viewBox="0 0 24 24" fill="currentColor" className="microphone-svg">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  },
  {
    ...
    icon: 
      `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
           strokeLinecap="round" strokeLinejoin="round" className="movie-svg">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  },
  {
    ...
    icon: 
      `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
           strokeLinecap="round" strokeLinejoin="round" className="game-svg">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  },
  {
    title: "Live",
    path: "/Live",
    icon: `<img className="live-img" src="/images/live.svg" alt="Live" />`,
  },
  {
    title: "Sport",
    path: "/Sport",
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
           strokeLinecap="round" strokeLinejoin="round" className="sport-svg">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  ...
  },
  {
    ...
    path: "/Beauty",
    icon: `
      <svg xmlns="http://www.w3.org/2000/svg" className="beauty-svg"
           width="200" height="200" viewBox="0 0 14 14">
        <g strokeLinecap="round" strokeLinejoin="round">
          <path d="M1.29 9.71a1 1 0 0 0 0 1.41l2.09 2.09a1 1 0 0 0 1.41 0L8.5 9.5L5 6z"/>
          <path d="M5.54 6.54L11.29.79a1 1 0 0 1 1.09-.21a1 1 0 0 1 .62.92v2.17a.999.999 0 0 1-.29.71L8 9m.04-4.96l2.5 2.5"/>
        </g>
      </svg>
`    ,
  },
