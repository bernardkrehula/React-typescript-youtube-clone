...
const Header = () => {
    ...
    return(
        <div className='header'>
            <Btn>
                <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  className="show-menu-icon"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 20h16" /><path d="M4 12h16" /><path d="M4 4h16" /></svg>
            </Btn>
            <Btn>
            ...
            <div className='search-bar'>
                <SingleInput vartiation='search-bar-input' placeholder='Search'></SingleInput>
