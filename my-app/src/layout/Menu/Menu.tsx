...
const Menu = () => {
    ...
    return(
        <div className='menu'>
            ...
            <Btn variation='menu-icon'>
                <div className='single-category'>
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="currentColor"  className="microphone"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M19 9a1 1 0 0 1 1 1a8 8 0 0 1 -6.999 7.938l-.001 2.062h3a1 1 0 0 1 0 2h-8a1 1 0 0 1 0 -2h3v-2.062a8 8 0 0 1 -7 -7.938a1 1 0 1 1 2 0a6 6 0 0 0 12 0a1 1 0 0 1 1 -1m-7 -8a4 4 0 0 1 4 4v5a4 4 0 1 1 -8 0v-5a4 4 0 0 1 4 -4" /></svg>
                    <h2>Podcast</h2>
                </div></Btn>
            <Btn variation='menu-icon'>
                <div className='single-category'>
            ...
            <Btn variation='menu-icon'>
                <div className='single-category'>
                    {/* <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        class="live-icon" aria-hidden="true" focusable="false">
                        <!-- center dot -->
                        <circle cx="12" cy="12" r="1.2" fill="currentColor"/>

                        <!-- right-side arcs (3 radii) -->
                        <path d="M12 9.5 A2.5 2.5 0 0 1 12 14.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.4"/>
                        <path d="M12 7.5 A4.5 4.5 0 0 1 12 16.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.4"/>
                        <path d="M12 5.5 A6.5 6.5 0 0 1 12 18.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.4"/>

                        <!-- left-side arcs (mirrored, sweep-flag 0) -->
                        <path d="M12 9.5 A2.5 2.5 0 0 0 12 14.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.4"/>
                        <path d="M12 7.5 A4.5 4.5 0 0 0 12 16.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.4"/>
                        <path d="M12 5.5 A6.5 6.5 0 0 0 12 18.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.4"/>
                    </svg> */}
                    <h2>Live</h2>
                </div></Btn>
            <Btn variation='menu-icon'>
                <div className='single-category'>
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-ball-volleyball"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M12 12a8 8 0 0 0 8 4" /><path d="M7.5 13.5a12 12 0 0 0 8.5 6.5" /><path d="M12 12a8 8 0 0 0 -7.464 4.928" /><path d="M12.951 7.353a12 12 0 0 0 -9.88 4.111" /><path d="M12 12a8 8 0 0 0 -.536 -8.928" /><path d="M15.549 15.147a12 12 0 0 0 1.38 -10.611" /></svg>
                    <h2>Sport</h2>
                </div></Btn>
            <Btn variation='menu-icon'>
                <div className='single-category'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 32 32" fill="#000000"><g fill="#000000"><path d="M16.01 4.62a.51.51 0 1 0 0-1.02a.51.51 0 0 0 0 1.02Z"/><path d="M15.322 29.067a1 1 0 0 0-.587-1.082l1.384-9.697l1.775 9.652a1 1 0 0 0-.716 1.127l.17 1.017a1 1 0 0 0 1.076.832l9.166-.833a1 1 0 0 0 .91-.996v-.996a1 1 0 0 0-.566-.902a3.355 3.355 0 0 0-.033-.566l-3.087-23.06A2.93 2.93 0 0 0 21.918 1H9.95l-.05.002a2.92 2.92 0 0 0-2.76 2.624l-2.492 23.53A1 1 0 0 0 4 28.09v.996a1 1 0 0 0 .91.996l9.166.833a1 1 0 0 0 1.077-.832l.17-1.017Zm10.607-1.843l-6.037.524L17.01 12.07l.134-.061a.851.851 0 0 0 .86-.85l.009-5.146H20c-.023 1.088.33 2.23 1 3.088a5 5 0 0 0 1.833 1.193c.148.056.56.165.897.25L25.92 26.9c.016.108.019.217.01.324ZM15 12h-.003l-2.25 15.76l-6.094-.53l1.783-16.85l.169-.023c.185-.023.38-.047.519-.1A5.001 5.001 0 0 0 10.92 9.08c.688-.849 1.066-1.976 1.07-3.068h5.012v4.732a.26.26 0 0 1-.24.26H15.69s-.7.004-.7.844L15 12ZM8.546 9.35l.353-3.338H11c-.002.855-.294 1.752-.83 2.418a4 4 0 0 1-1.46.92a.547.547 0 0 1-.164 0Zm.46-4.346l.124-1.175a.92.92 0 0 1 .87-.83h11.91a.93.93 0 0 1 .92.82l.159 1.185H9.006Zm14.118 1.008l.46 3.446a8.87 8.87 0 0 1-.311-.081A4 4 0 0 1 21.8 8.45c-.529-.676-.81-1.58-.8-2.438h2.124Z"/></g></svg>
                    <h2>Fashion</h2>
                </div></Btn>
            <Btn variation='menu-icon'>
                <div className='single-category'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" fill="#000000"><g fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"><path d="M1.29 9.71a1 1 0 0 0 0 1.41l2.09 2.09a1 1 0 0 0 1.41 0L8.5 9.5L5 6z"/><path d="M5.54 6.54L11.29.79a1 1 0 0 1 1.09-.21a1 1 0 0 1 .62.92v2.17a.999.999 0 0 1-.29.71L8 9m.04-4.96l2.5 2.5"/></g></svg>
                    <h2>Beauty</h2>
                </div></Btn>
        </div>
    )
